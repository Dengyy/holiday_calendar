...
const HOLIDAYS = ['2016-12-31', '2017-1-1', '2017-1-2', '2017-1-27', '2017-1-28', '2017-1-29', '2017-1-30', '2017-1-31', '2017-2-1', '2017-2-2', '2017-4-2', '2017-4-3', '2017-4-4', '2017-4-29', '2017-4-30', '2017-5-1', '2017-5-28', '2017-5-29', '2017-5-30', '2017-10-1', '2017-10-2', '2017-10-3', '2017-10-4', '2017-10-5', '2017-10-6', '2017-10-7', '2017-10-8'];
const WORKDAYS = ['2017-1-22', '2017-2-4', '2017-4-1', '2017-5-27', '2017-9-30'];
...
Page({
  ...
  getDateList: function (y, mon) {
    ...
    for (var i = 0; i < vm.data.daysCountArr[mon]; i++) {
      ...
      if (HOLIDAYS.indexOf(dateItem.value) > -1) {
        dateItem.type = 'holiday'
      } else if (WORKDAYS.indexOf(dateItem.value) > -1) {
        dateItem.type = 'workday'
      }
